...
export function newEthereumRpcSigner(a: number, b: number): void;
export function newStarknetRpcSigner(a: number, b: number, c: number, d: number, e: number, f: number): void;
