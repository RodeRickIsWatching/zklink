...
export interface InitOutput {
  ...
  readonly create2data_json_value: (a: number, b: number) => void;
  readonly changepubkey_json_value: (a: number, b: number) => void;
  readonly changepubkey_get_change_pubkey_message: (a: number, b: number, c: number, d: number, e: number) => void;
